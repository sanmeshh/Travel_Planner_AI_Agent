...
"""
    ...
    response = llm.invoke(prompt)#llm is here to convert the info given by user to json
    

    try:
        data = json.loads(response)#json.loads() to convert the string to a Python dictionary
    except Exception:
